...
// This component is optional and therefore the API will only work if it is installed
func (s Selenium) OptionFirefoxDefaultProfile() (map[string]interface{}, error) {
	return s.c.Request("selenium/view/optionFirefoxDefaultProfile/", nil)
}
...
//
// This component is optional and therefore the API will only work if it is installed
func (s Selenium) GetBrowserArguments(browser string) (map[string]interface{}, error) {
	m := map[string]string{
		"browser": browser,
	}
	return s.c.Request("selenium/view/getBrowserArguments/", m)
}
...
// This component is optional and therefore the API will only work if it is installed
func (s Selenium) SetOptionFirefoxDefaultProfile(str string) (map[string]interface{}, error) {
	m := map[string]string{
		"String": str,
	}
	return s.c.Request("selenium/action/setOptionFirefoxDefaultProfile/", m)
}
...
//
// This component is optional and therefore the API will only work if it is installed
func (s Selenium) AddBrowserArgument(browser string, argument string, enabled string) (map[string]interface{}, error) {
	m := map[string]string{
		"browser":  browser,
		"argument": argument,
		"enabled":  enabled,
	}
	return s.c.Request("selenium/action/addBrowserArgument/", m)
}

// Removes a browser argument.
//
// This component is optional and therefore the API will only work if it is installed
func (s Selenium) RemoveBrowserArgument(browser string, argument string) (map[string]interface{}, error) {
	m := map[string]string{
		"browser":  browser,
		"argument": argument,
	}
	return s.c.Request("selenium/action/removeBrowserArgument/", m)
}

// Sets whether or not a browser argument is enabled.
//
// This component is optional and therefore the API will only work if it is installed
func (s Selenium) SetBrowserArgumentEnabled(browser string, argument string, enabled string) (map[string]interface{}, error) {
	m := map[string]string{
		"browser":  browser,
		"argument": argument,
		"enabled":  enabled,
	}
	return s.c.Request("selenium/action/setBrowserArgumentEnabled/", m)
}
