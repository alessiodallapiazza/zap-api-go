...
func (a Ascan) OptionMaxAlertsPerRule() (map[string]interface{}, error) {
	return a.c.Request("ascan/view/optionMaxAlertsPerRule/", nil)
}
...
func (a Ascan) OptionEncodeCookieValues() (map[string]interface{}, error) {
	return a.c.Request("ascan/view/optionEncodeCookieValues/", nil)
}
...
func (a Ascan) SetOptionEncodeCookieValues(boolean bool) (map[string]interface{}, error) {
	m := map[string]string{
		"Boolean": strconv.FormatBool(boolean),
	}
	return a.c.Request("ascan/action/setOptionEncodeCookieValues/", m)
}
...
func (a Ascan) SetOptionMaxAlertsPerRule(i int) (map[string]interface{}, error) {
	m := map[string]string{
		"Integer": strconv.Itoa(i),
	}
	return a.c.Request("ascan/action/setOptionMaxAlertsPerRule/", m)
}
