...
func (s Search) UrlsByTagRegex(regex string, baseurl string, start string, count string) (map[string]interface{}, error) {
	m := map[string]string{
		"regex":   regex,
		"baseurl": baseurl,
		"start":   start,
	...
	return s.c.Request("search/view/urlsByTagRegex/", m)
}
...
func (s Search) MessagesByTagRegex(regex string, baseurl string, start string, count string) (map[string]interface{}, error) {
	m := map[string]string{
		"regex":   regex,
		"baseurl": baseurl,
		"start":   start,
	...
	return s.c.Request("search/view/messagesByTagRegex/", m)
}
...
func (s Search) HarByTagRegex(regex string, baseurl string, start string, count string) ([]byte, error) {
	m := map[string]string{
		"regex":   regex,
		"baseurl": baseurl,
		"start":   start,
	...
	return s.c.RequestOther("search/other/harByTagRegex/", m)
}
