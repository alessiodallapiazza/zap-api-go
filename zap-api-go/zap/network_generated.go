...
//
// This component is optional and therefore the API will only work if it is installed
func (n Network) GetRateLimitRules() (map[string]interface{}, error) {
	return n.c.Request("network/view/getRateLimitRules/", nil)
}
...
//
// This component is optional and therefore the API will only work if it is installed
func (n Network) AddRateLimitRule(description string, enabled string, matchregex string, matchstring string, requestspersecond string, groupby string) (map[string]interface{}, error) {
	m := map[string]string{
	...
	return n.c.Request("network/action/addRateLimitRule/", m)
}

// Remove a rate limit rule
//
// This component is optional and therefore the API will only work if it is installed
func (n Network) RemoveRateLimitRule(description string) (map[string]interface{}, error) {
	m := map[string]string{
		"description": description,
	}
	return n.c.Request("network/action/removeRateLimitRule/", m)
}

// Set enabled state for a rate limit rule.
//
// This component is optional and therefore the API will only work if it is installed
func (n Network) SetRateLimitRuleEnabled(description string, enabled string) (map[string]interface{}, error) {
	m := map[string]string{
		"description": description,
		"enabled":     enabled,
	}
	return n.c.Request("network/action/setRateLimitRuleEnabled/", m)
}
