...
func (c Core) GetLogLevel(name string) (map[string]interface{}, error) {
	m := map[string]string{
		"name": name,
	}
	return c.c.Request("core/view/getLogLevel/", m)
}
...
func (c Core) CreateSbomZip(filepath string) (map[string]interface{}, error) {
	m := map[string]string{
		"filePath": filepath,
	}
	return c.c.Request("core/action/createSbomZip/", m)
}
...
func (c Core) SetLogLevel(name string, loglevel string) (map[string]interface{}, error) {
	m := map[string]string{
		"name":     name,
		"logLevel": loglevel,
	}
	return c.c.Request("core/action/setLogLevel/", m)
}
...
func (c Core) FileDownload(filename string) ([]byte, error) {
	m := map[string]string{
		"fileName": filename,
	}
	return c.c.RequestOther("core/other/fileDownload/", m)
}
...
func (c Core) FileUpload(filename string, filecontents string) ([]byte, error) {
	m := map[string]string{
		"fileName":     filename,
		"fileContents": filecontents,
	}
	return c.c.RequestOther("core/other/fileUpload/", m)
}
